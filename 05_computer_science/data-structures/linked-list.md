...
| 단계 | 섹션                                                                                                                      |
|----|---------------------------------------------------------------------------------------------------------------------------|
| 기초 | [1. 개요](#1-개요) / [2. 종류](#2-종류) / [3. 구조](#3-구조)                                                                        |
| 분석 | [4. 시간 복잡도](#4-시간-복잡도) / [5. 공간 복잡도](#5-공간-복잡도)                                                                         |
| 실전 | [6. 구현 (Python)](#6-구현-python) / [7. 배열 vs 연결 리스트](#7-배열-vs-연결-리스트) / [8. 자주 나오는 문제 패턴](#8-자주-나오는-문제-패턴) / [9. 활용](#9-활용) |
