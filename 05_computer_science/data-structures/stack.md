...
| 단계 | 섹션                                                                           |
|----|--------------------------------------------------------------------------------|
| 기초 | [1. 개요](#1-개요) / [2. 구조](#2-구조) / [3. 핵심 연산](#3-핵심-연산)                       |
| 구현 | [4. 공간 복잡도](#4-공간-복잡도) / [5. 구현 (Python)](#5-구현-python) / [6. 응용 구현](#6-응용-구현) |
| 예시 | [7. 활용 예시: 괄호 검사](#7-활용-예시-괄호-검사) / [8. 활용 예시: 후위 표기법 계산](#8-활용-예시-후위-표기법-계산) |
| 실전 | [9. 자주 나오는 문제 패턴](#9-자주-나오는-문제-패턴) / [10. 활용](#10-활용)                        |
