...
| 단계 | 섹션                                                                           |
|----|--------------------------------------------------------------------------------|
| 기초 | [1. 개요](#1-개요) / [2. 종류](#2-종류) / [3. 구조](#3-구조) / [4. 배열 표현](#4-배열-표현)      |
| 연산 | [5. 핵심 연산](#5-핵심-연산) / [6. 공간 복잡도](#6-공간-복잡도) / [7. 구현 (Python)](#7-구현-python) |
| 심화 | [8. heapify가 O(n)인 이유](#8-heapify가-on인-이유) / [9. 힙 정렬](#9-힙-정렬)              |
...
완전 이진 트리(Complete Binary Tree) 기반으로, 부모-자식 간 대소 관계를 유지하는 자료구조. 우선순위 큐 구현에 사용.
