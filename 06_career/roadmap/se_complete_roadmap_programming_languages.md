# SE 로드맵 - 프로그래밍 언어 - 언어별 학습 가이드

## 목차

| 섹션                                                                                                                                    |
|-----------------------------------------------------------------------------------------------------------------------------------------|
| [언어 특징 비교](#언어-특징-비교) / [SE에게 추천하는 언어 우선순위](#se에게-추천하는-언어-우선순위) / [실무 사용 사례](#실무-사용-사례) |
| [비교표](#비교표) / [결론](#결론) / [SE가 배워야 할 언어 가이드](#se가-배워야-할-언어-가이드)                                           |
| [SE가 나아가야 할 방향](#se가-나아가야-할-방향) / [SE만으로 충분한가?](#se만으로-충분한가)                                              |
...
🟡 검증 불가 — 출처 필요: 아래 활용 비율은 공식 통계에 근거하지 않은 예시입니다.
- Python: 90%
- Bash: 80%
- Go: 30%
...
🟡 검증 불가 — 출처 필요: 아래 수요 등급은 채용 데이터 출처가 없는 예시입니다.

```
High Demand (many job postings)               
┌──────────────────────────┬────────────┐
│ SE + DevOps/SRE          │ ★★★★★      │
│ SE + Cloud Architect     │ ★★★★★      │
│ SE + Security            │ ★★★★☆      │
...
Low Demand (declining/traditional)             
┌──────────────────────────┬────────────┐
│ SE + Network             │ ★★☆☆☆      │
│ SE + Storage             │ ★★☆☆☆      │
└──────────────────────────┴────────────┘
...
🟡 검증 불가 — 출처 필요: 아래 연봉과 프리미엄은 공식 통계 출처가 없는 예시입니다.
