...
커리어 개발과 업무 도구. 로드맵, 법률 지식, AI 활용을 다룹니다.
...
| [ai_tools/](./ai_tools/) | AI 도구 — Kiro CLI, AI 개발 요청 템플릿, 프롬프트 엔지니어링 | 8       |
...
`roadmap (방향 설정)` → `ai_tools (생산성)` → `legal (리스크 인지)`

## 전제 조건

없음. 커리어 단계와 관계없이 참고 가능합니다.

## 관련 섹션

- SRE 실무: [03_engineering/reliability/](../03_engineering/reliability/)
- 전체 학습 경로: [루트 README 추천 학습 순서](../README.md#추천-학습-순서)
