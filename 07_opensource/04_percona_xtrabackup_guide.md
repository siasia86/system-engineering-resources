...
| 섹션 |
|------|
| [1. XtraBackup 소개](#1-xtrabackup-소개) / [2. 설치](#2-설치) / [3. 백업 전략](#3-백업-전략) |
| [4. Full Backup (전체 백업)](#4-full-backup-전체-백업) / [5. Incremental Backup (증분 백업)](#5-incremental-backup-증분-백업) / [6. 복원 (Restore)](#6-복원-restore) |
| [7. 자동화 스크립트](#7-자동화-스크립트) / [8. 트러블슈팅](#8-트러블슈팅) / [9. 베스트 프랙티스](#9-베스트-프랙티스) |
| [1. 상황 평가](#1-상황-평가) / [2. 백업 확인](#2-백업-확인) / [3. 복원 실행](#3-복원-실행) |
| [4. 검증](#4-검증) / [5. 사후 조치](#5-사후-조치) / [10. 고급 주제](#10-고급-주제) |
| [11. 체크리스트](#11-체크리스트) / [12. 참고 자료](#12-참고-자료) / [요약](#요약) |
| [13. 실무 팁 모음](#13-실무-팁-모음) |
