...
| 섹션 |
|------|
| [빠른 참조](#빠른-참조) / [ltrace란?](#1-ltrace란) / [ltrace ls 실행](#2-ltrace-ls-실행) |
| [출력 분석](#3-출력-분석) / [전체 실행 흐름](#4-전체-실행-흐름) / [ltrace 유용한 옵션](#5-ltrace-유용한-옵션) |
| [실용 예제](#6-실용-예제) / [트러블슈팅](#7-트러블슈팅) / [ltrace 내부 동작](#8-ltrace-내부-동작) |
| [제한사항](#9-제한사항) / [관련 도구](#10-관련-도구) / [실무 활용](#11-실무-활용) |
| [요약](#12-요약) / [ltrace vs strace 실전 선택 가이드](#13-ltrace-vs-strace-실전-선택-가이드) / [실전 디버깅 시나리오](#14-실전-디버깅-시나리오) |
| [성능 오버헤드 비교](#15-성능-오버헤드-비교) / [자주 발생하는 문제와 해결책](#16-자주-발생하는-문제와-해결책) / [에러 코드 해석 가이드](#17-에러-코드-해석-가이드) |
| [전체 출력 예시](#18-전체-출력-예시) / [추가 학습 자료](#19-추가-학습-자료) / [프로덕션 환경 사용 시 주의사항](#20-프로덕션-환경-사용-시-주의사항) |
