...
| 섹션                                                                                                                                                                                                           |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [1. 잔여 이슈](#1-잔여-이슈) / [2. md-style-check.py 개선](#2-md-style-checkpy-개선) / [3. reference 미검증](#3-_reference-미검증-항목) / [4. GitHub Actions 문서 검증 보강](#4-github-actions-문서-검증-보강) |
