...
| `repo-governance`        | 저장소 규칙·우선순위      | 저장소 작업      |
...
| `zircon-readme-policy`   | Zircon README 정책        | Zircon 문서 작업 |

## Agent 매핑

| agent            | 등록된 skills                                                                                 |
|------------------|-----------------------------------------------------------------------------------------------|
| system-engineer  | skill 17개 + file 3개 = 총 20개 (kiro-lock·zircon-readme-policy 미등록)                       |
