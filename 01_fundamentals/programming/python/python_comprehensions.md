...
Python의 리스트, 딕셔너리, 집합 컴프리헨션과 제너레이터 표현식에 대한 가이드입니다.

## 목차

| 섹션 |
|------|
| [어원과 역사](#1-어원과-역사) / [리스트 컴프리헨션](#2-리스트-컴프리헨션) / [딕셔너리 컴프리헨션](#3-딕셔너리-컴프리헨션) |
| [집합 컴프리헨션](#4-집합-컴프리헨션) / [제너레이터 표현식](#5-제너레이터-표현식) / [중첩 컴프리헨션](#6-중첩-컴프리헨션) |
| [실전 예제](#7-실전-예제) / [성능 비교](#8-성능-비교) / [실전 팁](#9-실전-팁) |
| [요약](#10-요약) |
