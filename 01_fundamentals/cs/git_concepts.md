...
| 섹션                                                                                       |
|--------------------------------------------------------------------------------------------|
| [1. Git이란](#1-git이란) / [2. 객체 모델](#2-객체-모델) / [3. 참조 시스템](#3-참조-시스템) |
| [4. 작업 영역 구조](#4-작업-영역-구조) / [5. 브랜치 전략](#5-브랜치-전략)                  |
| [6. merge vs rebase](#6-merge-vs-rebase) / [7. 원격 저장소](#7-원격-저장소)                |
| [8. 훅과 자동화](#8-훅과-자동화) / [9. 인프라에서의 Git 활용](#9-인프라에서의-git-활용)    |
