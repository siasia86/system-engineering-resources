...
| 섹션 |
|------|
| [1. CRUD 매핑](#1-crud-매핑) / [2. 주요 메서드](#2-주요-메서드) / [3. 추가 메서드](#3-추가-메서드) |
| [4. 속성 비교](#4-속성-비교) / [5. PUT vs PATCH 차이](#5-put-vs-patch-차이) / [6. 멱등성 (Idempotent)](#6-멱등성-idempotent) |
| [7. RESTful API 설계 예시](#7-restful-api-설계-예시) / [8. 상태 코드와 함께 사용](#8-상태-코드와-함께-사용) / [9. 실전 예제](#9-실전-예제) |
| [10. 보안 고려사항](#10-보안-고려사항) / [11. 추가 학습 자료](#11-추가-학습-자료) / [12. 요약](#12-요약) |
