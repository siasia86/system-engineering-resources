...
| 섹션                                                                                                                                      |
|-------------------------------------------------------------------------------------------------------------------------------------------|
| [1. 프로토콜 한 줄 요약](#1-프로토콜-한-줄-요약) / [2. 보안 수준 비교](#2-보안-수준-비교) / [3. 성능·오버헤드 비교](#3-성능오버헤드-비교) |
...
| WireGuard     | 2018 | 커널 내장, 최소 코드, 고성능, 최신 암호 스위트             | ✅ 현역   |
...
| 보안 감사 이력 | -          | -              | RFC 표준     | 20년+ 이력  | 2018 논문 검증    | 제한적            |
...
|----------------|------------|-------------|-----------|-----------|-------------------|
| 헤더 오버헤드  | ~76 bytes  | ~58 bytes   | ~30 bytes | ~32 bytes | ~60 bytes (TLS)   |
| 핸드셰이크 RTT | 7+ RTT     | 2 RTT       | 1 RTT     | 1 RTT     | TLS 1-RTT         |
| 커널 공간 처리 | ✅         | ✅          | ❌ 유저   | ✅ 5.6+   | ❌ 유저           |
