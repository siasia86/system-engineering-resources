...
현재 Linux 문서는 `README.md`를 제외하고 48개입니다. 개념 문서와 실습·분석 도구 문서를 함께 배치하여 개념 학습 후 실제 시스템 관찰로 이어지도록 구성합니다.
...
- [POSIX ACL·setfacl](./acl_setfacl_guide.md) — ACL·Default ACL·mask·권한 상속.
