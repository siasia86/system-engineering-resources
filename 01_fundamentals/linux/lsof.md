...
| 섹션                                                                                                   |
|--------------------------------------------------------------------------------------------------------|
| [1. lsof란?](#1-lsof란) / [2. 주요 기능](#2-주요-기능) / [3. 설치](#3-설치)                            |
| [4. 기본 사용법](#4-기본-사용법) / [5. 네트워크 연결](#5-네트워크-연결) / [6. 실전 예제](#6-실전-예제) |
| [7. 고급 사용법](#7-고급-사용법) / [8. 실무 활용](#8-실무-활용) / [9. 출력 필터링](#9-출력-필터링)     |
| [10. 트러블슈팅](#10-트러블슈팅) / [11. 유용한 조합](#11-유용한-조합) / [12. 파일 타입](#12-파일-타입) |
| [13. 파일 디스크립터](#13-파일-디스크립터) / [14. 관련 도구](#14-관련-도구) / [15. 요약](#15-요약)     |
