...
| 섹션                                                                                                       |
|------------------------------------------------------------------------------------------------------------|
| [1. iotop이란?](#1-iotop이란) / [2. 주요 기능](#2-주요-기능) / [3. 설치](#3-설치)                          |
| [4. 기본 사용법](#4-기본-사용법) / [5. 주요 옵션](#5-주요-옵션) / [6. 대화형 키](#6-대화형-키)             |
| [7. 실전 예제](#7-실전-예제) / [8. 배치 모드 활용](#8-배치-모드-활용) / [9. 실무 활용](#9-실무-활용)       |
| [10. 대안 도구](#10-대안-도구) / [11. 트러블슈팅](#11-트러블슈팅) / [12. 성능 고려사항](#12-성능-고려사항) |
| [13. 스크립트 예제](#13-스크립트-예제) / [14. 관련 도구](#14-관련-도구) / [15. 요약](#15-요약)             |
...
```bash
# iotop 자체의 오버헤드는 대상 프로세스·옵션·수집 간격에 따라 달라짐
# 메모리와 I/O 사용량도 실행 환경에 따라 별도 측정

# 프로덕션 환경에서는 영향 측정 후 제한적으로 사용
```
