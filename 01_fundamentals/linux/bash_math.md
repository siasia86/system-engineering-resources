...
| 섹션                                                                                                             |
|------------------------------------------------------------------------------------------------------------------|
| [1. 개요](#1-개요) / [2. 주요 활용](#2-주요-활용) / [3. 연산 방법](#3-연산-방법)                                 |
| [4. 산술 연산자](#4-산술-연산자) / [5. 실전 예제](#5-실전-예제) / [6. 자주 발생하는 오류](#6-자주-발생하는-오류) |
| [7. 권장 사항](#7-권장-사항)                                                                                     |
...
Bash 스크립팅에서 산술 연산을 수행하는 다양한 방법을 정리한 문서입니다.
...
Bash 산술 확장은 정수만 지원합니다. 소수점은 아래 도구 사용:
