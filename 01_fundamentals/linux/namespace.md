...
| 호스트 ns와 관계            | 공유 또는 격리 선택 가능      | 독립 (격리)         |
...
🟡 Docker Compose v5.x에서 `cgroupns_mode` 키가 제거되었습니다. `daemon.json`으로 기본값을 설정합니다. 상세 내용은 [docker.md 섹션 11](../../02_infrastructure/containers/docker.md#11-cgroup-namespace)을 참고합니다.
