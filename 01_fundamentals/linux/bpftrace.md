...
| 섹션                                                                                                       |
|------------------------------------------------------------------------------------------------------------|
| [1. bpftrace란?](#1-bpftrace란) / [2. 주요 특징](#2-주요-특징) / [3. 설치](#3-설치)                        |
| [4. 기본 사용법](#4-기본-사용법) / [5. 프로브 타입](#5-프로브-타입) / [6. 내장 변수](#6-내장-변수)         |
| [7. 실전 예제](#7-실전-예제) / [8. 고급 기능](#8-고급-기능) / [9. 유용한 스크립트](#9-유용한-스크립트)     |
| [10. 실무 활용](#10-실무-활용) / [11. 트러블슈팅](#11-트러블슈팅) / [12. 성능 고려사항](#12-성능-고려사항) |
| [13. 관련 도구](#13-관련-도구) / [14. 요약](#14-요약)                                                      |
