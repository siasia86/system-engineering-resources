...
| 섹션                                                                                                                                          |
|-----------------------------------------------------------------------------------------------------------------------------------------------|
| [1. 기초 개념](#1-기초-개념) / [2. 주요 Character Set](#2-주요-character-set) / [3. 주요 Encoding](#3-주요-encoding)                          |
| [4. BOM (Byte Order Mark)](#4-bom-byte-order-mark) / [5. 실무 예제](#5-실무-예제) / [6. 고급: 인코딩 문제 디버깅](#6-고급-인코딩-문제-디버깅) |
| [7. 정리](#7-정리)                                                                                                                            |
