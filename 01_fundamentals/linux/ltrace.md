...
| 섹션                                                                                                                                                                           |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [빠른 참조](#빠른-참조) / [1. ltrace란?](#1-ltrace란) / [2. ltrace ls 실행](#2-ltrace-ls-실행)                                                                                 |
| [3. 출력 분석](#3-출력-분석) / [4. 전체 실행 흐름](#4-전체-실행-흐름) / [5. ltrace 유용한 옵션](#5-ltrace-유용한-옵션)                                                         |
| [6. 실용 예제](#6-실용-예제) / [7. 트러블슈팅](#7-트러블슈팅) / [8. ltrace 내부 동작](#8-ltrace-내부-동작)                                                                     |
| [9. 제한사항](#9-제한사항) / [10. 관련 도구](#10-관련-도구) / [11. 실무 활용](#11-실무-활용)                                                                                   |
| [12. 요약](#12-요약) / [13. ltrace vs strace 실전 선택 가이드](#13-ltrace-vs-strace-실전-선택-가이드) / [14. 실전 디버깅 시나리오](#14-실전-디버깅-시나리오)                   |
| [15. 성능 오버헤드 비교](#15-성능-오버헤드-비교) / [16. 자주 발생하는 문제와 해결책](#16-자주-발생하는-문제와-해결책) / [17. 에러 코드 해석 가이드](#17-에러-코드-해석-가이드) |
| [18. 전체 출력 예시](#18-전체-출력-예시) / [19. 추가 학습 자료](#19-추가-학습-자료) / [20. 프로덕션 환경 사용 시 주의사항](#20-프로덕션-환경-사용-시-주의사항)                 |
...
**결론:**
- ltrace와 strace의 오버헤드는 대상과 옵션에 따라 달라짐
