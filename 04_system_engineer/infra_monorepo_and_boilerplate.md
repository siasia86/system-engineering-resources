...
| 섹션 |
|------|
| [1. Monorepo 구조](#1-monorepo-구조) |
| [2. Boilerplate (템플릿 자동 생성)](#2-boilerplate-템플릿-자동-생성) |
| [3. Runbook (운영 매뉴얼)](#3-runbook-운영-매뉴얼) |
| [사전 조건](#사전-조건) |
| [절차](#절차) |
| [롤백 절차](#롤백-절차) |
| [트러블슈팅](#트러블슈팅) |
| [3-1. Checklist (작업 체크리스트)](#3-1-checklist-작업-체크리스트) |
| [4. Postmortem (장애 보고서)](#4-postmortem-장애-보고서) |
| [타임라인](#타임라인) |
| [원인 분석](#원인-분석) |
| [조치 내용](#조치-내용) |
| [재발 방지](#재발-방지) |
