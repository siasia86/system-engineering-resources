...
| [4. 리소스 사용률 (Resource Utilization)](#4-리소스-사용률-resource-utilization) / [5. 보안 지표 (Security Metrics)](#5-보안-지표-security-metrics) |
...
HOST: sjyun                       Loss%   Snt   Last   Avg  Best  Wrst StDev
  ...
  4.├── 198.51.100.1             0.0%    20    1.2   1.6   1.0   6.0   1.1  
  5.├── 198.51.100.2             0.0%    20    1.6   2.6   1.2  16.7   3.6  
  6.├── 203.0.113.1              0.0%    20   25.4  23.8  22.1  26.2   1.6  
  7.├── 203.0.113.2            0.0%    20   29.8  27.6  25.3  29.8   1.2    
  8.├── 203.0.113.3             0.0%    20   29.5  27.6  25.5  31.9   1.6   
  ...                                                                       
...
- Warning Alert: 경고 알림 (CCU 70% 도달)
- Scale-out Prepare: 스케일아웃 준비 (CCU 90% 도달)
- Deploy Server / Queue System: 신규 서버 투입 또는 입장 대기열(Queue) 활성화
