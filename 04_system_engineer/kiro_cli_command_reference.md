...
| 단계           | 섹션                                                                       |
|----------------|----------------------------------------------------------------------------|
| 기본           | [1.명령어](#1-명령어-전체-목록) / [2.컨텍스트·도구](#2-컨텍스트--도구-상세) / [3.단축키](#3-단축키-및-특수-입력) |
...
| 커스터마이징   | [10.토큰](#10-토큰-절약--성능-최적화) / [11.Hooks](#11-hooks-사용자-정의-동작) / [12.Output](#12-output-style-출력-스타일-제어) / [13.실험적](#13-experimental-features-실험적-기능) |
| 고급 활용      | [14.병렬 처리](#14-병렬-처리-parallel-execution) / [15.CI/CD](#15-cicd-비대화형-모드) / [16.MCP](#16-mcp-서버-연동) |
| 레퍼런스·부록  | [17.트러블슈팅](#17-트러블슈팅) / [18.설정](#18-설정-옵션-전체-목록) / [19.모델](#19-model-모델-선택) / [20.대화](#20-대화-관리-chat-saveload) |
| 부록           | [21.활용도](#21-인프라-엔지니어-활용도-요약) / [22.참고 URL](#22-참고-url) |
