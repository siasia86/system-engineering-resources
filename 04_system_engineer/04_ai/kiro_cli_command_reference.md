...
| [7. 도구 권한 관리 (Tool Trust)](#7-도구-권한-관리-tool-trust) / [8. `/plan` — Plan 에이전트 상세](#8-plan--plan-에이전트-상세) / [마이그레이션 계획](#마이그레이션-계획) |
| [9. `.kiro/` 디렉토리 활용](#9-kiro-디렉토리-활용) / [10. 토큰 절약 & 성능 최적화](#10-토큰-절약--성능-최적화) / [1. 복명복창 (작업 확인)](#1-복명복창-작업-확인) |
| [1. Confirm before action](#1-confirm-before-action) / [11. Hooks (사용자 정의 동작)](#11-hooks-사용자-정의-동작) / [12. Output Style (출력 스타일 제어)](#12-output-style-출력-스타일-제어) |
