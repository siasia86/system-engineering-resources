...
| 단계 | 섹션 |
|------|------|
| 기초 | [1. DBA 역할과 SE와의 차이](#1-dba-역할과-se와의-차이) / [2. 필수 기초 지식](#2-필수-기초-지식) |
| 중급 | [3. RDBMS 심화](#3-rdbms-심화) / [4. 운영 및 모니터링](#4-운영-및-모니터링) |
| 고급 | [5. 고가용성 & 확장성](#5-고가용성--확장성) / [6. NoSQL & 클라우드 DB](#6-nosql--클라우드-db) |
| 커리어 | [7. 학습 로드맵](#7-학습-로드맵) / [8. 자격증](#8-자격증) |
