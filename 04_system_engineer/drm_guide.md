...
DRM(Digital Rights Management)은 디지털 콘텐츠의 **무단 복제, 배포, 수정을 기술적으로 제한**하는 수단이다.
저작권자가 콘텐츠 사용 조건을 강제하기 위해 소프트웨어/하드웨어 수준에서 적용한다.
...
GPL v3 Section 6은 소스코드뿐 아니라 **설치 정보(Installation Information)**도 제공하도록 요구한다.
