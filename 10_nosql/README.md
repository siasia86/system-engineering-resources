...
| 분류 | 문서 | 설명 |
|------|------|------|
| **문서형** | [MongoDB](nosql_mongodb.md) | Document DB, Aggregation Pipeline, 스키마 설계 |
| **키-값형** | [Redis](nosql_redis.md) | 인메모리, 캐시, 분산 락, 실시간 랭킹 |
| **검색형** | [Elasticsearch](nosql_elasticsearch.md) | 전문 검색, 로그 분석, ELK Stack |
