...
- 2026년 3월 기준 국내 약 700개 이상 기관이 AS번호 보유
...
| 항목                  | USD           | KRW                  |
|-----------------------|---------------|----------------------|
| APNIC ASN 등록비      | ~500          | ~75만                |
| IPv4 /24 구매 (256개) | ~7,500~12,800 | ~1,125만~1,920만     |
| BGP 라우터            | ~3,000~10,000 | ~450만~1,500만       |
| 초기 구축 인건비      | -             | ~300만~500만         |
| **합계**              |               | **~2,000만~4,000만** |
...
|--------------------------|--------------------|
| APNIC 연회비 (÷12)       | ~16만              |
| ISP 회선 A (BGP transit) | ~75만~300만        |
| ISP 회선 B (이중화)      | ~75만~300만        |
| IX 포트비 (KINX 등, 1G)  | ~45만~75만         |
| IDC 코로케이션 (1/4랙)   | ~30만~80만         |
| 장비 전력/유지보수       | ~10만~20만         |
| 네트워크 엔지니어 (겸직) | ~100만~200만       |
| **월 합계**              | **~350만~1,000만** |
...
| 규모      | 월 비용         | 설명                                          |
|-----------|-----------------|-----------------------------------------------|
| 최소 구성 | ~350만~500만    | ISP 2개 소규모 회선, IX 미가입, 엔지니어 겸직 |
| 일반 구성 | ~500만~800만    | ISP 2개 + IX 1개, 겸직 운영                   |
| 여유 구성 | ~800만~1,000만+ | ISP 2개 + IX, 전담 인력, 이중화 장비          |
...
| 국내 ISP 클린존 (KT/SKB/LGU+) | ✅         | △       | ❌       | ~50만~200만              | IDC 회선 부가서비스, 별도 장비 불필요 |
...
- APNIC 서비스 요금: <https://www.apnic.net/manage-ip/manage-resources/fees/>
- APNIC ASN 신청 가이드: <https://www.apnic.net/manage-ip/getting-resources/autonomous-system-numbers/>
- BGP 기본 개념 (Cloudflare): <https://www.cloudflare.com/learning/security/glossary/what-is-bgp/>
- RPKI 개요 (Cloudflare): <https://www.cloudflare.com/learning/security/glossary/what-is-rpki/>
