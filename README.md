...
### 2. [기본 Linux 명령어](02_basic_linux/)
자주 사용하는 Linux 명령어 및 스크립팅
- [Bash 수학 연산](02_basic_linux/bash_math.md)
- [Bash trap 가이드](02_basic_linux/bash_trap_complete_guide.md)
- [Root 패스워드 복구](02_basic_linux/root_password_recovery.md)
- [Vim 사용법](02_basic_linux/vim.md)
...
#### 초급 (Linux 입문)
1. [기본 Linux 명령어](02_basic_linux/)
2. [Vim 사용법](02_basic_linux/vim.md)
