...
| 섹션 |
|------|
| [상속이란?](#1-상속이란) / [기본 상속](#2-기본-상속) / [super() 함수](#3-super-함수) |
| [다중 상속](#4-다중-상속) / [메서드 오버라이딩](#5-메서드-오버라이딩) / [추상 클래스](#6-추상-클래스) |
| [실전 예제](#7-실전-예제) / [상속 vs 컴포지션](#8-상속-vs-컴포지션) / [실전 팁](#9-실전-팁) |
| [베스트 프랙티스](#10-베스트-프랙티스) / [자주하는 실수](#11-자주하는-실수) / [요약](#12-요약) |
