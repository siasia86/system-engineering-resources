# Linux Kernel CVE — CVE-2026-31431 algif_aead (2026)
...
| CVE-2026-43284 | 8.8 | HIGH | ❌ | — | ✅ (→ [별도 문서](./cve_dirty_frag_2026.md)) |
| CVE-2026-43500 | 7.8 | HIGH | ❌ | — | ✅ (→ [별도 문서](./cve_dirty_frag_2026.md)) |
...
CVE-2026-43284 (`xfrm/ESP`) 및 CVE-2026-43500 (`rxrpc`)는 동일 계열 취약점으로 별도 문서에서 관리합니다.

→ [cve_dirty_frag_2026.md](./cve_dirty_frag_2026.md)
...
| 항목 | 결과 | 비고 |
|------|------|------|
| 커널 버전 | ❌ 취약 | 6.8.0-101 — CVE-2026-31431 취약 범위 (6.12.x 브랜치) |
...
> CVE-2026-43284 / CVE-2026-43500 (esp4, esp6, rxrpc) 테스트 결과는 [cve_dirty_frag_2026.md — 영향 범위 확인](./cve_dirty_frag_2026.md#3-영향-범위-확인) 참고.
...
**CVE-2026-43284 / CVE-2026-43500 (esp4, esp6, rxrpc) 완화:**
→ [cve_dirty_frag_2026.md — 임시 완화](./cve_dirty_frag_2026.md#4-대처-방안)

**CVE-2026-31431 (algif_aead) 완화:**
...
# ⚠️ AF_ALG 소켓을 사용하는 애플리케이션(OpenSSL AF_ALG 엔진 등) 영향 가능
sudo rmmod algif_aead 2>/dev/null || true
echo "install algif_aead /bin/false" | sudo tee /etc/modprobe.d/disable-algif-aead.conf
...
- [cve_dirty_frag_2026.md](./cve_dirty_frag_2026.md) — CVE-2026-43284 / CVE-2026-43500 (Dirty Frag)
